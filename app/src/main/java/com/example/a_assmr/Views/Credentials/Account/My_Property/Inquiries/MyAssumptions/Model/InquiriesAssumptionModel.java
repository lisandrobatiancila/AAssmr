...
public class InquiriesAssumptionModel {
    ...
    public InquiriesAssumptionModel(int userID, int ID, int propID, String userEmail, String info1, String info2, String info3, String info4, String info5, String info6) {
        this.userID = userID;
        this.ID = ID;
        this.propID = propID;
