...
import com.example.a_assmr.Views.Credentials.Properties.PropertyLists.Vehicle.VehicleController.VehiclePropController;
...
public class VehicleFragment extends Fragment implements VehicleInterface {
    ...
    public void propertyLists(List<Vehicles> vehiclesList) {
        dialog.dismiss();
        VehicleRVAdapter Vadapter = new VehicleRVAdapter(context, vehiclesList);
